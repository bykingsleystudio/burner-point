...
@Module({
  imports: [
    ...
    // NestJS throttler (additional layer on top of our Redis middleware)
    ThrottlerModule.forRootAsync({
      ...
      useFactory: (cfg: ConfigService) => ({
        throttlers: [
          {
            ttl: parseInt(cfg.get('RATE_LIMIT_TTL_MS', '60000')),
            limit: parseInt(cfg.get('RATE_LIMIT_MAX_REQUESTS', '60')),
          },
        ],
      }),
    }),
