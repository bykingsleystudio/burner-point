...
export const metadata = {
  ...
  description: 'Verify your Burner Point account phone number.',
};
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-brand-black px-4 text-white">
      <div className="bp-state max-w-md">
        <p className="font-mono text-xs uppercase tracking-[0.18em] text-white/72">Preparing phone verification...</p>
      </div>
    </main>
  );
}
