      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_22rem]">
        <div className="rounded-[1.5rem] border border-white/8 bg-brand-card p-5">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {plans.length ? (
              plans.map((plan) => (
                <article key={plan.id} className="rounded-[1.2rem] border border-white/8 bg-black/20 p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2 text-sm text-white/60">
                    <div className="rounded-[0.95rem] border border-white/8 bg-black/24 px-3 py-2">
