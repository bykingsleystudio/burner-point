...
marketingPages.help = {
  ...
  cards: [
    ...
    { icon: 'book', meta: 'Payments', title: 'Balance, purchases, receipts, and references', text: 'Troubleshoot checkout status, available balance, call credits, subscriptions, and payment gateway references.', href: '/help-center#help-payments', anchorId: 'help-payments' },
