...
const ENV_ALIASES: Record<string, string[]> = {
  ...
  NEXT_PUBLIC_SUPABASE_ANON_KEY: ['NEXT_PUBLIC_SUPABASE_ANON_KEY', 'NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY'],
  NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: ['NEXT_PUBLIC_SUPABASE_ANON_KEY', 'NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY'],
  EXPO_PUBLIC_SUPABASE_ANON_KEY: ['EXPO_PUBLIC_SUPABASE_ANON_KEY', 'EXPO_PUBLIC_SUPABASE_PUBLISHABLE_KEY'],
  EXPO_PUBLIC_SUPABASE_PUBLISHABLE_KEY: ['EXPO_PUBLIC_SUPABASE_ANON_KEY', 'EXPO_PUBLIC_SUPABASE_PUBLISHABLE_KEY'],
