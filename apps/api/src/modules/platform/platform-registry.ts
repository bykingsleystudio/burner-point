...
export const STACK_REGISTRY: StackIntegrationDefinition[] = [
  ...
  },
  {
    ...
    priority: 'primary',
    exposure: 'server-only',
    role: 'US/Canada number infrastructure and long-term number quality',
  ...
  {
    id: 'vonage-conversation',
    name: 'Vonage',
    category: 'telecom',
    priority: 'fallback',
    exposure: 'server-only',
    role: 'Conversation fallback reliability',
    productSurface: 'SMS/voice backup routing',
  ...
  },
  {
    ...
    priority: 'primary',
    exposure: 'server-only',
    role: 'Global verification route provider',
  ...
  {
    id: 'vonage-verify',
    name: 'Vonage Verify / SMS',
    category: 'telecom',
    priority: 'fallback',
    exposure: 'server-only',
    role: 'Verification backup and smart fallback',
