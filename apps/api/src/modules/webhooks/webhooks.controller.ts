...
export class WebhooksController {
  ...
  async twilioSms(@Body() body: Record<string, string>, @Req() req: Request, @Res() res: Response) {
  ...
  async twilioVoice(@Body() body: Record<string, string>, @Req() req: Request, @Res() res: Response) {
    this.service.assertTwilioRequest(req);
  ...
  async twilioStatus(@Body() body: Record<string, string>, @Req() req: Request) {
    this.service.assertTwilioRequest(req);
  ...
  async twilioRecording(@Body() body: Record<string, string>, @Req() req: Request) {
    this.service.assertTwilioRequest(req);
  ...
  async twilioVerify(@Body() body: Record<string, string>, @Req() req: Request) {
    this.service.assertTwilioRequest(req);
  ...
  async bandwidthWebhook(
    @Body() body: Record<string, unknown> | Array<Record<string, unknown>>,
    @Headers() headers: Record<string, string>,
    @Req() req: RawBodyRequest<Request>,
  ) {
