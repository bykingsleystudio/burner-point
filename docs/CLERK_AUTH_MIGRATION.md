...
- Enable phone number as a sign-in identifier if phone login is required.
...
- Mobile: create account with required profile fields and confirm tabs load after Clerk activation.
